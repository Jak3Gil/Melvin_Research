...
# The qt_en.qm file is empty, so we'll disable other languages to force English
...
if (Test-Path $motorToolExe) {
    ...
    Write-Host "(Qt's default untranslated text is English)" -ForegroundColor Gray
    Write-Host ""
